...
export default class AuthService {
    ...
    static async addWrite(from:string,name:string,to:string,contact:string,date:string,time:string):Promise<AxiosResponse<string>>{
        return $api.post('/addWrite',{from,to,name,contact,date,time});//
    }
